...
root = Tk()
root.withdraw()
msg.showinfo('게임 방법', '레이싱 게임은 방향키를 사용하여 하는 게임입니다!')
...
class Car:
    car_image = ['Car21.png', 'Car22.png', 'Car23.png', 'Car24.png', 'Car25.png', \
                 'Car29.png', 'Car30.png','Car31.png', 'Car32.png', 'Car33.png',  \
                 'Car34.png', 'Car35.png','Car36.png', 'Car37.png', 'Car38.png', 'Car39.png']
    ...
    def load_car(self, p=""):
        if p == "p":
            # 플레이어 차량
            self.image = pygame.image.load(DIRCARS + "car26.png")
            # 크기 조정
...
def main():
    ...
    a = pygame.mixer.Sound(DIRSOUND + 'background.ogg')
